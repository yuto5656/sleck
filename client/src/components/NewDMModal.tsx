    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg w-full max-w-md mx-4">
        <div className="flex items-center justify-between p-4 border-b dark:border-gray-700">
          <h2 className="text-lg font-bold text-gray-900 dark:text-white">新しいメッセージ</h2>
          <button
            type="button"
            onClick={onClose}
        ...
        <div className="p-4">
          ...
          <div className="relative mb-4">
            ...
            <input
              ...
              placeholder="メンバーを検索..."
              className="w-full pl-10 pr-4 py-2 border dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-slack-purple bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500"
              autoFocus
            />
          </div>
              ...
              <div className="space-y-1">
                {filteredMembers.map((member) => (
                  <button
                    ...
                    disabled={isCreating}
                    className={clsx(
                      'w-full flex items-center gap-3 p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700 text-left',
